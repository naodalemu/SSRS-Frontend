    ...
    return (
        <Backdrop onCloseBackdrop={closeBackdrop}>
            <div className={classes.cartSummary} onClick={(e) => e.stopPropagation()}>
                ...
                {cart.length === 0 ? (
                    <p className={classes.emptyCartMessage}>Please add an item to order.</p>
                ) : (
                        ...
                        {cart.map((item, index) => (
                            <li key={index} className={classes.cartItem}>
                                <div className={classes.itemDetails}>
                                    ...
                                    x <span className={classes.priceValue}>${item.price}</span>
                                </div>
                ...
                <button onClick={closeBackdrop} className={classes.closeButton}><FaWindowClose /></button>
            </div>       
        </Backdrop>
    );
}
